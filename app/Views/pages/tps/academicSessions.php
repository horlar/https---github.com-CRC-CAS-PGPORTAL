...
<?= $this->section('pageCss') ?>
    ...
    <link href="<?= base_url() ?>/script/tps/datatables/datatables.bundle.css" rel="stylesheet" type="text/css">
        <!-- END PAGE LEVEL STYLES -->
<?= $this->endSection() ?>

<?= $this->section("content") ?>
    <?= $this->include('partials/tps/academicSessions') ?>
<?= $this->endSection() ?>


<?= $this->section('pageJs') ?>
    <!-- BEGIN PAGE LEVEL SCRIPTS -->
    <script src="<?= base_url() ?>/script/tps/datatables/datatables.bundle.js"></script>
