				...
				<div class="col-lg-6">
					...
					<div class="card card-custom gutter-b example example-compact">
						<div class="card-header">
							<h3 class="card-title">Result Entry Form</h3>
						...
						<form class="form">
							<div class="card-body">
								<div class="row">
                                    <div class="col-lg-6">
                                        <div class="form-group row">
                                            <div class="col-lg-12">
                                                ...
                                                <input type="text" class="form-control" id="matricno" name="matricno" placeholder="Enter Matric No" />
                                            </div>
                                        </div>	
                                        ...
                                        <div class="form-group row">
                                            <div class="col-lg-12">
                                                ...
                                                <input type="text" class="form-control" id="othernames" name="surname" placeholder="Enter Other Names" />
                                            </div>
                                        </div>
                                    ...
                                    <div class="col-lg-6">
                                        <h4>Select Courses and Grades</h4>
                                        <div class="form-group row">
                                            <div class="col-lg-7">
                                                <select class="form-control kt_select2_1" id="coursecode1" name="coursecode1">
                                                    <option selected value="AK">Select Course Code</option>  
                                                    <option value="AK">2010/2011</option>
                                                    <option value="HI">2011/2012</option>
                                                    <option value="CA">2012/1013</option>
                                                </select>
                                            ...
                                            <div class="col-lg-5">
                                                <select class="form-control kt_select2_1" id="grade1" name="grade1">
                                                    <option selected value="AK">Select Grade</option>  
                                                    <option value="AK">A</option>
                                                    <option value="HI">B</option>
                                                    <option value="AK">C</option>
                                                    <option value="HI">D</option>
                                                    <option value="AK">E</option>
                                                    <option value="HI">F</option>
                                                </select>
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            <div class="col-lg-7">
                                                <select class="form-control kt_select2_1" id="coursecode2" name="coursecode2">
                                                    <option selected value="AK">Select Course Code</option>  
                                                    <option value="AK">2010/2011</option>
                                                    <option value="HI">2011/2012</option>
                                                    <option value="CA">2012/1013</option>
                                            ...
                                            <div class="col-lg-5">
                                                <select class="form-control kt_select2_1" id="grade2" name="grade2">
                                                    <option selected value="AK">Select Grade</option>  
                                                    <option value="AK">A</option>
                                                    <option value="HI">B</option>
                                                    <option value="AK">C</option>
                                        ...
                                        <div class="form-group row">
                                            <div class="col-lg-7">
                                                <select class="form-control kt_select2_1" id="coursecode3" name="coursecode3">
                                                    <option selected value="AK">Select Course Code</option>  
                                                    <option value="AK">2010/2011</option>
                                                    <option value="HI">2011/2012</option>
                                                    <option value="CA">2012/1013</option>
                                            ...
                                            <div class="col-lg-5">
                                                <select class="form-control kt_select2_1" id="grade3" name="grade3">
                                                    <option selected value="AK">Select Grade</option>  
                                                    <option value="AK">A</option>
                                                    <option value="HI">B</option>
                                                    <option value="AK">C</option>
                                        ...
                                        <div class="form-group row">
                                            <div class="col-lg-7">
                                                <select class="form-control kt_select2_1" id="coursecode4" name="coursecode4">
                                                    <option selected value="AK">Select Course Code</option>  
                                                    <option value="AK">2010/2011</option>
                                                    <option value="HI">2011/2012</option>
                                                    <option value="CA">2012/1013</option>
                                            ...
                                            <div class="col-lg-5">
                                                <select class="form-control kt_select2_1" id="grade4" name="grade4">
                                                    <option selected value="AK">Select Grade</option>  
                                                    <option value="AK">A</option>
                                                    <option value="HI">B</option>
                                                    <option value="AK">C</option>
                                        ...
                                        <div class="form-group row">
                                            <div class="col-lg-7">
                                                <select class="form-control kt_select2_1" id="coursecode5" name="coursecode5">
                                                    <option selected value="AK">Select Course Code</option>  
                                                    <option value="AK">2010/2011</option>
                                                    <option value="HI">2011/2012</option>
                                                    <option value="CA">2012/1013</option>
                                            ...
                                            <div class="col-lg-5">
                                                <select class="form-control kt_select2_1" id="grade5" name="grade5">
                                                    <option selected value="AK">Select Grade</option>  
                                                    <option value="AK">A</option>
                                                    <option value="HI">B</option>
                                                    <option value="AK">C</option>
                                        ...
                                        <div class="form-group row">
                                            <div class="col-lg-7">
                                                <select class="form-control kt_select2_1" id="coursecode6" name="coursecode6">
                                                    <option selected value="AK">Select Course Code</option>  
                                                    <option value="AK">2010/2011</option>
                                                    <option value="HI">2011/2012</option>
                                                    <option value="CA">2012/1013</option>
                                            ...
                                            <div class="col-lg-5">
                                                <select class="form-control kt_select2_1" id="grade6" name="grade6">
                                                    <option selected value="AK">Select Grade</option>  
                                                    <option value="AK">A</option>
                                                    <option value="HI">B</option>
                                                    <option value="AK">C</option>
                                        ...
                                        <div class="form-group row">
                                            <div class="col-lg-7">
                                                <select class="form-control kt_select2_1" id="coursecode7" name="coursecode7">
                                                    <option selected value="AK">Select Course Code</option>  
                                                    <option value="AK">2010/2011</option>
                                                    <option value="HI">2011/2012</option>
                                                    <option value="CA">2012/1013</option>
                                            ...
                                            <div class="col-lg-5">
                                                <select class="form-control kt_select2_1" id="grade7" name="grade7">
                                                    <option selected value="AK">Select Grade</option>  
                                                    <option value="AK">A</option>
                                                    <option value="HI">B</option>
                                                    <option value="AK">C</option>
                                        ...
                                        <div class="form-group row">
                                            <div class="col-lg-7">
                                                <select class="form-control kt_select2_1" id="coursecode8" name="coursecode8">
                                                    <option selected value="AK">Select Course Code</option>  
                                                    <option value="AK">2010/2011</option>
                                                    <option value="HI">2011/2012</option>
                                                    <option value="CA">2012/1013</option>
                                            ...
                                            <div class="col-lg-5">
                                                <select class="form-control kt_select2_1" id="grade8" name="grade8">
                                                    <option selected value="AK">Select Grade</option>  
                                                    <option value="AK">A</option>
                                                    <option value="HI">B</option>
                                                    <option value="AK">C</option>
