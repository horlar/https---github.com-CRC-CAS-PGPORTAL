                        ...
                        <div class="card-header">
                            <div class="form-group row">
                                <div class="col-lg-12 text-right">
                                    ...
                                    <input type="search" id="searchResults" class="form-control" action="#searchResultsTable" placeholder="Matric Number"/><br>
                                    <button type="search" class="btn btn-primary mr-2">Search &nbsp; &nbsp; <span><i class="fas fa-search"></i></span></button>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div class="row">
                ...
                <div class="col-lg-12">
					...
					<div class="card card-custom gutter-b">
						...
						<div class="card-body">
							<!--begin: Datatable-->
							<table class="table table-bordered table-checkable" id="kt_datatable" hidden>
								<thead>
									<tr>
										<th>S/N</th>
										<th>Matric No</th>
