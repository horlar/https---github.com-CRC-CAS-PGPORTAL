							...
							<div class="card-body">
								<div class="form-group row">
									<div class="col-lg-12">
										...
										<input type="text" class="form-control" id="schoolcode" placeholder="Enter School Code" />
										<span class="form-text text-muted">Please Enter School Code</span>
									</div>
								</div>	
								...
								<div class="form-group row">
									<div class="col-lg-12">
										...
										<input type="text" class="form-control" id="schoolname" placeholder="Enter Full Name of School" />
										<span class="form-text text-muted">Please enter Full Name of School</span>
									</div>
								</div>	
							</div>
