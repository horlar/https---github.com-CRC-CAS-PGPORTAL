				...
				<div class="col-lg-3">
					...
					<div class="card card-custom gutter-b example example-compact">
						<div class="card-header">
							<h3 class="card-title">User Account Setup</h3>
						</div>
						<!--begin::Form-->
                        <form class="form">
							<div class="card-body">
                                <div class="form-group row">
                                    <div class="col-lg-6">
                                        ...
                                        <select class="form-control" name="userclass" id="userclass" required>
                                            <option></option>
                                            <option>UAC</option>
                                            <option>CRC</option>
                                        </select>                                                    
                                ...
                                <div class="form-group row">
                                    <div class="col-lg-6">
                                        <label for="department">Employment No *</label>
                                        <input type="text" class="form-control" name="employmentno" id="employmentno" required>
                                    </div>
                                    <div class="col-lg-6">
                                        <label for="department">Status *</label>
                                        <select class="form-control" name="salute" id="salute">
                                            <option></option>
                                            <option>Miss.</option>
                                            <option>Mrs.</option>
                                            <option>Mr.</option>
								...
								<div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="onames" id="onames" required>
                                </div>                                
                                <div class="form-group">
                                    <label for="phone_no">Current Position *</label>
                                    <input type="text" class="form-control" name="presentposition" id="presentposition" required>
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    <label for="phone_no">Username *</label>
                                ...
                                <input type="submit" name="wp-submit" class="btn btn-primary btn-block" value="Create Account" />
                                <hr>
                            </div>
                        </form>
						...
						<!-- <form class="form">
							...
							<div class="card-footer">
								<div class="row">
									<div class="col-lg-6">
										<button type="reset" class="btn btn-primary mr-2">Create User</button>
									</div>
