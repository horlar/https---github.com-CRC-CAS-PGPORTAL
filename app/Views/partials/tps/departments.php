				...
				<div class="col-lg-4">
					...
					<div class="card card-custom gutter-b example example-compact">
						<div class="card-header">
							<h3 class="card-title">Departments Setup</h3>
						</div>
						<!--begin::Form-->
						<form class="form">
							<div class="card-body">
								<div class="form-group row">
									<div class="col-lg-12">
										...
										<input type="text" class="form-control" id="departmentcode" name="departmentcode" placeholder="Enter Department Code" />
								...
								<div class="form-group row">
									<div class="col-lg-12">
										...
										<input type="text" class="form-control" id="departmentname" name="departmentname" placeholder="Enter Full Name of Department" />
										<span class="form-text text-muted">Please enter Full Name of Department</span>
									</div>
								</div>	

                                <div class="form-group row">
                                    <label>School Code *</label>
                                    <select class="form-control kt_select2_1" id="schoolcode" name="schoolcode">
