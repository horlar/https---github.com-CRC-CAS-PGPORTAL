				...
				<div class="col-lg-4">
					...
					<div class="card card-custom gutter-b example example-compact">
						<div class="card-header">
							<h3 class="card-title">Option Setup</h3>
						</div>
						<!--begin::Form-->
						<form class="form">
							<div class="card-body">
								<div class="form-group row">
									<div class="col-lg-12">
										...
										<input type="text" class="form-control" id="optioncode" name="optioncode" placeholder="Enter Option Code" />
										<span class="form-text text-muted">Please Option Code</span>
									</div>
								</div>	
								...
								<div class="form-group row">
									<div class="col-lg-12">
										...
										<input type="text" class="form-control" id="optionname" name="optionname" placeholder="Enter Full Name of Option" />
										<span class="form-text text-muted">Please enter Full Name of Option</span>
									</div>
								</div>	
