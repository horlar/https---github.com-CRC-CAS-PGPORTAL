				...
				<div class="col-lg-6">
					...
					<div class="card card-custom gutter-b example example-compact">
						<div class="card-header">
							<h3 class="card-title">Academic Session Setup</h3>
						</div>
						<!--begin::Form-->
						<form class="form">
							<div class="card-body">
								<div class="form-group row">
									<div class="col-lg-12">
										...
										<input type="text" class="form-control" id="sessionref" placeholder="Enter Session Ref" />
										<span class="form-text text-muted">Please enter Session Ref</span>
									</div>
								</div>								
							</div>
